            ...
            for j in range(jj):
                for i in range(ii):
                    ...
                    if j > 0 and self.sim.vp[i, j-1, k] > 0.0:
                        ...
                        ro3 = (self.sim.rhosco[ipvtr3_0] + rso3 * self.sim.rhoscg[ipvtr3_0]) / self.sim.bo[i, j-1, k]
                        rw3 = (self.sim.rhoscw[ipvtr3_0] + rsw3 * self.sim.rhoscg[ipvtr3_0]) / self.sim.bw[i, j-1, k]
                        rg3 = self.sim.rhoscg[ipvtr3_0] / self.sim.bg[i, j-1, k]
                    ...
                    if j < jj - 1 and self.sim.vp[i, j+1, k] > 0.0:
                        ...
                        ro4 = (self.sim.rhosco[ipvtr4_0] + rso4 * self.sim.rhoscg[ipvtr4_0]) / self.sim.bo[i, j+1, k]
                        rw4 = (self.sim.rhoscw[ipvtr4_0] + rsw4 * self.sim.rhoscg[ipvtr4_0]) / self.sim.bw[i, j+1, k]
                        rg4 = self.sim.rhoscg[ipvtr4_0] / self.sim.bg[i, j+1, k]
                    ...
                    if k > 0 and self.sim.vp[i, j, k-1] > 0.0:
                        ...
                        ro5 = (self.sim.rhosco[ipvtr5_0] + rso5 * self.sim.rhoscg[ipvtr5_0]) / self.sim.bo[i, j, k-1]
                        rw5 = (self.sim.rhoscw[ipvtr5_0] + rsw5 * self.sim.rhoscg[ipvtr5_0]) / self.sim.bw[i, j, k-1]
                        rg5 = self.sim.rhoscg[ipvtr5_0] / self.sim.bg[i, j, k-1]
                    ...
                    if k < kk - 1 and self.sim.vp[i, j, k+1] > 0.0:
                        ...
                        ro6 = (self.sim.rhosco[ipvtr6_0] + rso6 * self.sim.rhoscg[ipvtr6_0]) / self.sim.bo[i, j, k+1]
                        rw6 = (self.sim.rhoscw[ipvtr6_0] + rsw6 * self.sim.rhoscg[ipvtr6_0]) / self.sim.bw[i, j, k+1]
                        rg6 = self.sim.rhoscg[ipvtr6_0] / self.sim.bg[i, j, k+1]
